-- =============================================================================
-- Copia de `seed_fase4.sql` para o MODO DEMONSTRACAO.
--
-- O original ja foi aplicado quando ainda nao havia viagem nenhuma, e por isso
-- nao fez nada: o bloco sai cedo se `trips` estiver vazia. O `db push
-- --include-seed` **nao reexecuta** um seed ja aplicado — so atualiza o hash —,
-- entao a unica forma de rodar a mesma logica depois que `seed_demo.sql` cria
-- a viagem e um arquivo com nome novo.
--
-- Conteudo identico ao original, de proposito: duplicar a logica aqui e como
