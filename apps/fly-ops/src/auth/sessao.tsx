...
/** Papeis que operam o painel. Guia e midia usam o Fly Crew, nao o Fly Ops. */
const PAPEIS_DO_PAINEL: FlyRole[] = ['admin', 'trip_manager', 'support', 'finance', 'experience'];
...
export function SessaoProvider({ children }: { children: ReactNode }) {
  ...
  const aplicar = useCallback(async (sessao: Session | null) => {
    ...
    if (!papeis.some((p) => PAPEIS_DO_PAINEL.includes(p))) {
