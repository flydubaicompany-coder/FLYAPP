...
export const HUB: readonly ItemDoHub[] = [
  ...
  },
  {
    chave: 'mala',
    rotulo: 'Mala Pronta',
    descricao: 'O que levar, vindo do que cada dia do roteiro pede.',
    rota: '/viagem/mala',
    fase: null,
    ref: '§15.4',
  },
  ...
  },
  {
    chave: 'album',
    rotulo: 'Álbum',
    descricao: 'Cada dia da viagem é um capítulo, com as figurinhas dele.',
    rota: '/album',
    fase: null,
    ref: '§13.1',
  },
  {
    chave: 'quest',
    rotulo: 'Fly Quest',
    descricao: 'Missões pela cidade, com pontos e figurinhas.',
    rota: '/quest',
    fase: null,
    ref: '§14.1',
  },
